...
const SAMPLE_ENTRIES = [
  {
    ...
    duration: '15 min',
    reaction: 'loved',
    reflection: 'Spent 30 minutes just pouring and scooping! Asked to do it again before bed. Pure concentration!',
    doAgain: true,
  ...
  },
  {
    ...
    duration: '20 min',
    reaction: 'liked',
    reflection: 'Made a lion mask and roared at daddy when he came home! Didn\'t expect such commitment to the character!',
    doAgain: true,
  ...
  },
  {
    ...
    duration: '10 min',
    reaction: 'liked',
    reflection: 'Laughed so hard making silly faces. Those eyes just lit up in the mirror!',
    doAgain: false,
  ...
  },
  {
    ...
    duration: '15 min',
    reaction: 'meh',
    reflection: 'Was more interested in wearing the socks as gloves. Still cute though!',
    doAgain: false,
